...
# Constants
MAX_NUM_WORDS = 400
MAPPING_DICT = {0: 'automobile', 1: 'science', 2: 'politics', 3: 'technology', 4: 'sports', 5: 'entertainment',
                6: 'world'}
...
class StandardMLPredictor:
    ...
    def remove_stopwords(self, series):
    ...
    def label_news(self, processed_text):
        labels = self.model.predict(processed_text)
